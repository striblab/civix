...
const defaultSections = [
  ...
  },
  {
    ...
    filter: contest => {
      return (
        contest.office_id && contest.office_id.match(/usa-congress-house/i)
      );
    },
    headings: contest => {
  ...
  },
  {
    ...
    filename: 'ELEX_MNGOV',
    filter: contest => {
      return contest.office_id && contest.office_id.match(/usa-mn-governor/i);
    },
    headings: () => null
  },
  {
  ...
  },
  {
    ...
    filter: contest => {
      return (
        contest.office_id && contest.office_id.match(/usa-mn-state-lower/i)
      );
    },
    headings: contest => {
      return [`${contest.office.shortTitle}`];
  ...
  },
  {
    ...
    filter: contest => {
      return (
        contest.office_id && contest.office_id.match(/usa-mn-state-upper/i)
      );
    },
    headings: contest => {
  ...
  },
  {
    ...
    headings: contest => {
      ...
      return [`${contest.office.body.shortTitle}`, title2];
    }
  },
  {
    ...
    filter: contest => {
      return (
        contest.office_id && contest.office_id.match(/usa-mn-district-court/i)
      );
    },
    headings: contest => {
  ...
  },
  {
    ...
    headings: contest => {
      ...
      return [
        area,
        contest.office.subArea
          ? contest.office.title
            .replace(contest.office.area, '')
            .replace(contest.office.subArea, '')
            .trim()
          : special(contest, contest.office.shortTitle),
        contest.office.subArea ? special(contest, contest.office.subArea) : null
      ];
    }
  }
];
...
function makeSection(section, contests) {
  ...
  filtered = _.orderBy(
    filtered,
    [c => (section.headings(c) ? section.headings(c)[0] : c.sort), 'asc'],
    [
      c =>
        section.headings(c) && section.headings(c)[1]
          ? section.headings(c)[1]
          : '',
      'asc'
    ],
    [
