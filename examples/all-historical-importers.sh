...
./bin/civix.js import mn-boundaries/soil-water-subdistrict --year=2018 && \
./bin/civix.js import mn-boundaries/soil-water-subdistrict --year=2016 && \
./bin/civix.js import mn-boundaries/soil-water-subdistrict --year=2014
