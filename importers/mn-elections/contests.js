...
module.exports = async function mnElectionsMNContestsImporter({
  ...
  let contests = await mnElections.results();
  ...
  for (let contest of contests) {
    ...
    // Add records
    records.push({ model: models.Boundary, record: boundary });
    records.push({ model: models.Office, record: office });
    records.push({ model: models.Contest, record: contestRecord });

    for (let candidate of candidates) {
      records.push({ model: models.Candidate, record: candidate });
    }
  }
};
